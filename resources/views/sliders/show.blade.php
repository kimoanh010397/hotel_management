        ...
        @else
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td><a href="{{ route('slider.create', $room->id) }}" class="btn btn-success">Add Slider</a></td>
                    <td><a href="{{ route('slider.edit', $room->id) }}" class="btn btn-primary">Edit Slider</a></td>
                    <td>
                        <form action="{{ route('slider.destroy', $room->id) }}" method="post">
                            @csrf
